...
import org.test.po.MailMessage;

import sun.misc.BASE64Encoder;

public class SendMailImpl implements org.test.service.SendMail
{
	...
	//设置邮件的信息内容,以方法连得方式实现
	public SendMailImpl setMessage(MailMessage message)
	{
	 ...
	 * @return
	 */
	public static  SendMailImpl getInstance(int sendMailType)
	{
		SendMailImpl sendMailImp=new SendMailImpl();
		switch(sendMailType)
		{
		case SINA:
